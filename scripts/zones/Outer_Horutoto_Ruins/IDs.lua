...
zones[xi.zone.OUTER_HORUTOTO_RUINS] =
{
    text =
    {
        ...
        DOOR_FIRMLY_SHUT              = 7266,  -- The door is firmly shut.
        ALL_G_ORBS_ENERGIZED          = 7269,  -- The six Mana Orbs have been successfully energized with magic!
        ...
        PLAYER_OBTAINS_ITEM           = 8269,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 8270,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 8271,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 8272,  -- You already possess that temporary item.
        NO_COMBINATION                = 8277,  -- You were unable to enter a combination.
